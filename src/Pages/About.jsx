    ...
    <div>
      <div className="menu-container-about">
        <div className="img-section-about">
          <img className='img-about' src={Imagen2} alt='aboutUs' />
        </div>
      ...
      <div style={{color: '#000', marginBottom: '20px'}} className="our-story">
        <h3 style={{fontWeight: 'bold', fontFamily: 'Cormorant Garamond', color: '#1a68bc', marginBottom: '60px', margin: '0 auto'}}>Our story</h3>
        <p style={{fontSize: '20px', margin: '0 auto', width: 'auto', maxWidth: '1200px'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos nemo autem perspiciatis quas rem, a distinctio non ullam totam nam.</p>
        <p style={{fontSize: '20px', margin: '0 auto', width: 'auto', maxWidth: '1200px'}}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis assumenda ab repudiandae laudantium eum quis pariatur, sed provident deleniti obcaecati quia libero id illum sunt!</p>
        <p style={{fontSize: '20px', marginBottom: '100px', margin: '0 auto', width: 'auto', maxWidth: '1200px'}}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis assumenda ab repudiandae laudantium eum quis pariatur, sed provident deleniti obcaecati quia libero id illum sunt! Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis assumenda ab repudiandae laudantium eum quis pariatur, sed provident deleniti obcaecati quia libero id illum sunt! Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis assumenda ab repudiandae laudantium eum quis pariatur, sed provident deleniti obcaecati quia libero id illum sunt!</p>
      </div>
      <svg style={{marginTop: '-60px', marginBottom: '40px'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,192L48,213.3C96,235,192,277,288,272C384,267,480,213,576,208C672,203,768,245,864,229.3C960,213,1056,139,1152,144C1248,149,1344,235,1392,277.3L1440,320L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
    </div>
  );
}
